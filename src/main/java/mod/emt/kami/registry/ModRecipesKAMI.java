    ...
    private static void initInfusionRecipes() {
        ThaumcraftApi.addInfusionCraftingRecipe(new ResourceLocation(Kami.MOD_ID, "awakened_ichorium_axe"),
                new InfusionRecipe("KAMI_AWAKENED_ICHORIUM_AXE", new ItemStack(ModItemsKAMI.AWAKENED_ICHORIUM_AXE), 10,
                        new AspectList().add(Aspect.ENERGY, 1000).add(Aspect.FLIGHT, 1000).add(Aspect.MOTION, 1000).add(Aspect.PLANT, 1000).add(Aspect.TOOL, 1000).add(Aspect.WATER, 1000),
        ...
        ThaumcraftApi.addInfusionCraftingRecipe(new ResourceLocation(Kami.MOD_ID, "awakened_ichorium_pickaxe"),
                new InfusionRecipe("KAMI_AWAKENED_ICHORIUM_PICKAXE", new ItemStack(ModItemsKAMI.AWAKENED_ICHORIUM_PICKAXE), 10,
                        new AspectList().add(Aspect.DESIRE, 1000).add(Aspect.ENTROPY, 1000).add(Aspect.FIRE, 1000).add(Aspect.FLUX, 1000).add(Aspect.METAL, 1000).add(Aspect.TOOL, 1000),
                        ItemsTC.primordialPearl,
                        new ItemStack(Items.NETHER_STAR),
                        new ItemStack(Items.NETHER_STAR),
                        new ItemStack(Items.NETHER_STAR),
        ...
        ThaumcraftApi.addInfusionCraftingRecipe(new ResourceLocation(Kami.MOD_ID, "awakened_ichorium_shovel"),
                new InfusionRecipe("KAMI_AWAKENED_ICHORIUM_SHOVEL", new ItemStack(ModItemsKAMI.AWAKENED_ICHORIUM_SHOVEL), 10,
                        new AspectList().add(Aspect.DEATH, 1000).add(Aspect.EARTH, 1000).add(Aspect.MOTION, 1000).add(Aspect.TOOL, 1000).add(Aspect.TRAP, 1000).add(Aspect.UNDEAD, 1000),
                        ItemsTC.primordialPearl,
                        new ItemStack(Items.NETHER_STAR),
                        new ItemStack(Items.NETHER_STAR),
                        new ItemStack(Items.NETHER_STAR),
        ...
        ThaumcraftApi.addInfusionCraftingRecipe(new ResourceLocation(Kami.MOD_ID, "awakened_ichorium_sword"),
                new InfusionRecipe("KAMI_AWAKENED_ICHORIUM_SWORD", new ItemStack(ModItemsKAMI.AWAKENED_ICHORIUM_SWORD), 10,
                        new AspectList().add(Aspect.AIR, 1000).add(Aspect.AVERSION, 1000).add(Aspect.MIND, 1000).add(Aspect.ORDER, 1000).add(Aspect.SENSES, 1000).add(Aspect.SOUL, 1000),
                        ItemsTC.primordialPearl,
                        new ItemStack(Items.NETHER_STAR),
                        new ItemStack(Items.NETHER_STAR),
                        new ItemStack(Items.NETHER_STAR),
        ...
        ThaumcraftApi.addInfusionCraftingRecipe(new ResourceLocation(Kami.MOD_ID, "ichorium_block"),
                new InfusionRecipe("KAMI_ICHORIUM", new ItemStack(ModBlocksKAMI.ICHORIUM_BLOCK), 10,
                        new AspectList().add(Aspect.AIR, 1000).add(Aspect.EARTH, 1000).add(Aspect.FIRE, 1000).add(Aspect.METAL, 1000).add(Aspect.WATER, 1000),
                        "blockVoid",
