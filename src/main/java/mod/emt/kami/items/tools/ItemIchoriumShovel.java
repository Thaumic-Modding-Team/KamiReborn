...
public class ItemIchoriumShovel extends ItemSpade implements IWarpingGear {
    public ItemIchoriumShovel() {
        this("ichorium_shovel");
    }

    protected ItemIchoriumShovel(String unlocName) {
